...
public class Scan_Document extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan__document);
    ...
    private void handleScanInterface() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED || checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Scan_Document.this, new
    ...
    private void uploadToFirebase(final View v) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Scan_Document.this, "Failed to upload", Toast.LENGTH_SHORT).show();
            }
        ...
        switch (requestCode) {
            case REQUEST_WRITE_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(Scan_Document.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                    handleScanInterface();
                }
        }
    }
    ...
    class MyUploadTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            Toast.makeText(Scan_Document.this, "uploaded", Toast.LENGTH_SHORT).show();
            //show success
        }
    }
}